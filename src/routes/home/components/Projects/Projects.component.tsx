      ...
      <div className="navigation-container">
        <div className="project">
            ...
            <div className="project_description">
              ...
              {language.code === "en" ? <p>Little practising project.</p> : <p>Kis gyakorló projekt.</p>}
        ...
        <div className="project">
            ...
            {language.code === "en" ? <p>Another little practising project.</p> : <p>Mégegy kis gyakorló projekt.</p>}
              <p>Stack: HTML, SCSS, React, Typescript.</p> 
        ...
        <div className="project">
            ...
            {language.code === "en" ? <p>First major project.</p> : <p>Első nagyobb projekt.</p>}
        ...
        <div className="project">
            ...
            {language.code === "en" ? <p>Second major project.</p> : <p>Második nagyobb projekt.</p>}
              <p>Stack: HTML, CSS, React.</p> 
